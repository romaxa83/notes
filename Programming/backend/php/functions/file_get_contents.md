...
с помощью встроенной функции **`file_get_contents`** можно считывать как локальные файлы так и на удаленном сервере (парсинг сайтов) успешно, как и с помощью [[curl#🔹 PHP cURL основы|curl]].  
