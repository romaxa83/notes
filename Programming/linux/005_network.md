...
**Nmap (Network Mapper)** — это мощный инструмент с открытым исходным кодом для исследования сети и аудита безопасности. На macOS он пользуется большой популярностью среди системных администраторов и специалистов по безопасности. Подробнее здесь [[nmap]]
